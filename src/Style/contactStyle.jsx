...
const Contact = () => {
  return (
    <div className="max-w-3xl mx-auto p-10 bg-gray-100 rounded-lg shadow-md">
      ...
      <ul className="list-none p-0 mb-8">
        <li className="flex items-center mb-4 text-lg text-gray-700">
          <span
        ...
        <li className="flex items-center mb-4 text-lg text-gray-700">
          ...
          ></span>
          <strong className="text-gray-800 font-semibold">Address:</strong>
          &nbsp;Tel-Aviv
        </li>
      </ul>
